...
/**
 * RawErasureCoder is a common interface for {@link RawErasureEncoder} and {@link RawErasureDecoder}
 * as both encoder and decoder share some properties.
 *
 * RawErasureCoder is part of ErasureCodec framework, where ErasureCoder is used to encode/decode a
 * group of blocks (BlockGroup) according to the codec specific BlockGroup layout and logic. An
 * ErasureCoder extracts chunks of data from the blocks and can employ various low level
...
public interface RawErasureCoder extends Configurable {
  ...
  /**
   * The number of data input units for the coding. A unit can be a byte, chunk or buffer or even a
   * block.
   * 
  ...
  /**
   * The number of parity output units for the coding. A unit can be a byte, chunk, buffer or even a
   * block.
   * 
