...
#include "alluxio_erasurecode_rawcoder_NativeRSRawDecoder.h"
...
Java_alluxio_erasurecode_rawcoder_NativeRSRawDecoder_initImpl(
...
JNIEXPORT void JNICALL
Java_alluxio_erasurecode_rawcoder_NativeRSRawDecoder_decodeImpl(
...
JNIEXPORT void JNICALL
Java_alluxio_erasurecode_rawcoder_NativeRSRawDecoder_destroyImpl(
