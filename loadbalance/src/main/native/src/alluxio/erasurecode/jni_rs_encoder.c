...
#include "alluxio_erasurecode_rawcoder_NativeRSRawEncoder.h"
...
Java_alluxio_erasurecode_rawcoder_NativeRSRawEncoder_initImpl(
...
JNIEXPORT void JNICALL
Java_alluxio_erasurecode_rawcoder_NativeRSRawEncoder_encodeImpl(
...
JNIEXPORT void JNICALL
Java_alluxio_erasurecode_rawcoder_NativeRSRawEncoder_destroyImpl(
