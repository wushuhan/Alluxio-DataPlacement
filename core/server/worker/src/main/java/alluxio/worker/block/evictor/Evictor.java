...
public interface Evictor {
  ...
  /**
   * check the validity of move block to upper tier, based on approximated solution of the
   * 0/1 Knapsack Problem
   * @param blockId
   * @param location
   * @return true means the move action is validated by fault
   */
  boolean checkWithKnapsackProblem(long blockId, BlockStoreLocation location);
