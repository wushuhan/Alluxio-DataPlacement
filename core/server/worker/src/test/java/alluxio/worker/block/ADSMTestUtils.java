 ...
 */
public final class ADSMTestUtils {
    /**
     * [sjz] 修改了原生TieredBlockStoreTestUtils类,将存储层拓展为3层结构,因为现有ADSMEvictor类没有考虑单层多dir,所以每层只设置一个dir
     */
    public static final int[] TIER_ORDINAL = {0, 1, 2};
    public static final String[] TIER_ALIAS = {"MEM", "SSD", "HDD"};
    public static final String[][] TIER_PATH = {{"/mem/0"}, {"/ssd/0"}, {"/hdd/0"}};
    public static final long[][] TIER_CAPACITY_BYTES = {{2000}, {10 * 1024 * 1024}, {10 * 1024 * 1024}};
