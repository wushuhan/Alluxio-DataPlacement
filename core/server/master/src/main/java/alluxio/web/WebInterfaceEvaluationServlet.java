 ...
 */
@ThreadSafe
public final class WebInterfaceEvaluationServlet extends HttpServlet {
  private static final Logger LOG = LoggerFactory.getLogger(WebInterfaceEvaluationServlet.class);
  ...
  /**
   * Creates a new instance of {@link WebInterfaceEvaluationServlet}.
   *
   * @param masterProcess Alluxio master process
   */
  public WebInterfaceEvaluationServlet(MasterProcess masterProcess) {
